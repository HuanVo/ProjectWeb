                    ...
                    <div class="tab_content pd0" id="tab1">
                        ...
                        <!-- weigh -->
                         <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneFour">
                                    <input type="text"  id="param_weigh" style="width:100px" name="weigh" value="<?php echo $product_info->weigh ?>">
                                    <img src="<?php echo public_url(); ?>/admin/crown/images/icons/notifications/information.png" style="margin-bottom:-8px" title="Khối lượng hàng, Ví dụ: 500 g, >1 kg, <700 g,..." class="tipS">
                                </span>
